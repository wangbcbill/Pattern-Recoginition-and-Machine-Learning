...
plt.plot(np.arange(1,21), test_accuracies)
plt.axis([0, 20, 0, 90])
plt.xticks(np.arange(0, 21, 2))
...
############################################################################
# 2.(a) Keep the Block 5, learn a CovNet only with Block1                  #
############################################################################
...
def three_layer_convnet_test1():
    ...
    with tf.device(device):
        ...
        params = [conv_w1, conv_b1, conv_w5, conv_b5]
        logits = convnet_forward1(x, params)
...
with tf.device('/cpu:0'):
    three_layer_convnet_test1()

params1, params_val1, train_losses1, test_accuracies1 = train(convnet_forward1, convnet_init1, learning_rate, epochs=epochs)

############################################################################
# 2.(a) Keep the Block 5, learn a CovNet only with Block1 and Block2       #
############################################################################
...
def three_layer_convnet_test2():
    ...
    with tf.device(device):
        ...
        params = [conv_w1, conv_b1, conv_w2, conv_b2, conv_w5, conv_b5]
        logits = convnet_forward2(x, params)
...
with tf.device('/cpu:0'):
    three_layer_convnet_test2()

params2, params_val2, train_losses2, test_accuracies2 = train(convnet_forward2, convnet_init2, learning_rate, epochs=epochs)

###############################################################################
# 2.(a) Keep the Block 5, learn a CovNet only with Block1, Block2 and Block3  #
###############################################################################
...
def three_layer_convnet_test3():
    ...
    with tf.device(device):
        ...
        params = [conv_w1, conv_b1, conv_w2, conv_b2, conv_w3, conv_b3, conv_w5, conv_b5]
        logits = convnet_forward3(x, params)
...
with tf.device('/cpu:0'):
    three_layer_convnet_test3()

params3, params_val3, train_losses3, test_accuracies3 = train(convnet_forward3, convnet_init3, learning_rate, epochs=epochs)
